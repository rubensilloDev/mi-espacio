 ...
 * porque GitHub Pages bloquea popups por COOP.
 */
...
// Recoger el resultado del redirect al volver de Google
auth.getRedirectResult().then(result => {
  // Si hay resultado es que venimos de un redirect de Google
  // onAuthStateChanged lo gestiona automáticamente
}).catch(e => {
...
// Botón Google — usa redirect en vez de popup
